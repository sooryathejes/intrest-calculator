...
function App() {
  ...
  return (
    ...
    <div style={{height:"100vh"}} className='d-flex w-100 justify-content-center align-items-center bg-dark' >
      <div  style={{width:"400px"}} className=' bg-light rounded p-5'> 
      <div className='heading'>
        <h3>Simple Calculator</h3>
        <p>Calculate your simple interest Easily</p>
      </div>
      <div  className='interest-card w-100 flex-column rounded d-flex justify-content-center align-items-center bg-danger text-light shadow'>
        <h1>₹ {' '} {interest}  </h1>
      ...
      <Button type='submit' style={{width:'200px',height:'70px'}} variant="contained"  className='bg-dark'>CALCULATE</Button>
